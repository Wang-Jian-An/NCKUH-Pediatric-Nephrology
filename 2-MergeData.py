...
# 輸入重要資訊與透析資料
vital_signs_data = pd.read_pickle(os.path.join(main_raw_data_path, "Vital_signs.gzip"), "gzip")
dialysis_data = pd.read_pickle(os.path.join(main_raw_data_path, "Dialysis.gzip"), "gzip")
...
total_vital_signs_data.iloc[:50, :].to_excel("preprocessed_data/Merge_Vital_signs_and_Dialysis-Merge-1-sample（欲分析者請用gzip檔案）.xlsx", index = None)
total_vital_signs_data.to_pickle("preprocessed_data/Merge_Vital_signs_and_Dialysis-Merge-1.gzip", "gzip")